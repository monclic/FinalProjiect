        ...
        <div class="item-wrapper">
          <div class="item-content">
            <div class="content-wrapper">
              ...
              <div v-if="item.imagesIs" @click="show_detail(item.id)" class="item-a">
...
const getPage = async () => {
  currentPage.value++
  const param = { PageNumber: currentPage.value.toString(), PageSize: PageSize.value,order:2}
...
const delete_do = () => {
  ...
  http.post('/shorts/deletea', sid.value,{
    headers: {
