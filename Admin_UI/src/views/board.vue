<template>
  <div class="bcontainer">
    <div class="publish">
      <el-input style="width: 900px;margin-left: 30px;" v-model="textarea" :rows="2" type="textarea"
        placeholder="Please input" />
      <div @click="publish"
        style="width: 90px;height: 50px;border-radius: 10px;margin-left: 10px; background-color: #72c7ea;color:#fff;text-align: center;padding-top: 10px;font-weight: 400;font-size: x-large;">
        发布</div>
    </div>
