  ...
  <div class="container">
          ...
          <template #default="{ item, index }">
            <div class="item-wrapper">
              <div class="item-content">
               <div @click="show_detail(item.id)" class="content-wrapper">
                <div  class="item-info">
    ...
    <div class="shorts-aside">
      ...
      <div class="shorts-aside-wrapper">
        <div class="sort">
          <div @click="order(1)" class="sort_item">综合排序</div>
          <div @click="order(2)" class="sort_item">最新发布</div>
          <div @click="order(3)" class="sort_item">最多点赞</div>
          <div @click="order(4)" class="sort_item">最多回复</div>
        </div>
        <div class="others">
